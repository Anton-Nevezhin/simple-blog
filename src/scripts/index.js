...
// import { ls } from './single.js'
// console.log(ls)

// import '../lib/config'
// import '../lib/edit'

// import { rec } from '../lib/config.js'
// console.log('Из config: ', rec)

// import { recEdit } from '../lib/edit.js'
// console.log('Из single: ', recEdit)

// import { a } from './single.js'
// console.log('Из single: ', a)

// console.log(hello) // Выведет "Hello, World!"
...
// Автор, дата
  ...
  blogcardButton.addEventListener('click', () => {
    let a
    a = 'single.html?n=' + records[i].date
