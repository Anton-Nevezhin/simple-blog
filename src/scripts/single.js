...
//   a = document.getElementById('gh').value
//   localStorage.setItem('mas', a)
//   let sin = localStorage.getItem('mas')
//   console.log(sin)
// })

// document.getElementById('glebtn').addEventListener('click', () => {
//   let a
//   a = 'prim.html'
//   document.location.assign(a)
// })
...
// sButton.className = 'blogcard-button'
// sButton.innerHTML = 'Редактировать'
// document.getElementById('sbtn').appendChild(sButton)
