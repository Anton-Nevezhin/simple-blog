...
for (let i = 0; i < records.length; i++) {
  ...
  // singleImage.src = 'static/img/02.jpg'
  singleImage.src = records[4].image
  // singleImage.src = 'static/img/01.83d35ee.png'
